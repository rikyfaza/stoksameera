  ...
  <div class="box box-warning">
	...
	<div class="box-body">
	  ...
	  <?php echo form_open('product/create_product','role="form"') ; ?>		
		...
		<input type='hidden' name='returnbackto' id='returnbackto' value='<?php print $this->uri->segment(3); ?>' />
		
		<div class="form-group">
			<button class="btn btn-success" type="submit" ><?php echo $this->lang->line('common_form_elements_save'); ?></button>
			<a href="<?php if($this->uri->segment(3)==null){echo site_url().'/product/index';}else{print site_url().'/purchase/add_product/'.$this->uri->segment(3);} ?>" class="btn btn-warning" style='float:right'><?php echo $this->lang->line('common_form_elements_cancel'); ?></a>
		</div>
