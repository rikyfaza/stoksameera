				...
				<?php foreach($query->result() as $result) : ?>
				  <tr>
					...
					<td>
						...
						<div class="btn-group">
						  <a href="<?php echo site_url().'/receipt/order_detail/'.$result->purchase_id; ?>" title='Detail amount of order and received product' class='btn btn-primary'><i class="fa fa-search"></i> <?php print $this->lang->line('common_form_elements_detail'); ?></a>
						</div>
